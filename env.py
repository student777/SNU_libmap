...
# 이러면 사용할 때는 docs/해당하는 pickle 파일을 open해서 pickle.load만 해서 쓰면 될 것 같아요
...
def main():
    f = open("docs/자료실.pickle", "wb")
    room_nums = {'docs/1자료실.xlsx': 1, 'docs/2자료실.xlsx': 2, 'docs/3자료실.xlsx': 3,
                 'docs/4자료실.xlsx': 4, 'docs/5자료실.xlsx': 5, 'docs/6자료실.xlsx': 6,
                 'docs/7자료실.xlsx': 7, 'docs/1자료실_단행본.xlsx': '1-1', 'docs/7자료실_단행본.xlsx': '7-1'}
